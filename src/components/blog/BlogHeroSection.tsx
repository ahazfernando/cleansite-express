import { CheckCircle, BookOpen, TrendingUp, Users } from "lucide-react";
import { Button } from "@/components/ui/button";
import Link from "next/link";

const trustBadges = [
    { icon: CheckCircle, text: "Expert Writers" },
    { icon: CheckCircle, text: "Weekly Updates" },
    { icon: CheckCircle, text: "Free Resources" },
];
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center py-16 md:py-24">
                    ...
                    <div className="text-white space-y-6">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                            Cleaning Tips &{" "}
                            <span className="italic text-green-300">Insights</span>
                        </h1>

                        <p className="text-lg text-white/90 max-w-lg">
                            Discover expert advice, industry insights, and practical tips to keep your spaces spotless and healthy.
                        </p>

                        {/* About Us Button and Reviews */}
                        <div className="flex flex-wrap items-center gap-6 pt-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-white">
                                    ...
                                    <p className="text-sm text-white/80">50+ Articles</p>
                                </div>
                            </div>
                        </div>
